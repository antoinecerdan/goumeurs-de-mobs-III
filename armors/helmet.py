...
# La classe "Helmet" hérite de la classe "Armor"
class Helmet(Armor):
    # La méthode __init__ de la classe "Helmet" utilise la méthode __init__ de la classe "Armor" pour initialiser les attributs de la classe "Helmet"
